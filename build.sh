...
set -eu
cd "$(dirname "$0")"
mkdir -p build/'JIAYU Token Float 0.1.0.app'/Contents/{MacOS,Resources}
APP='build/JIAYU Token Float 0.1.0.app'
xcrun swiftc -O -module-cache-path build/ModuleCache -target arm64-apple-macos13.0 Sources/Core.swift Sources/App.swift Sources/Tests.swift -o "$APP/Contents/MacOS/TokenFloat"
...
<key>CFBundleName</key><string>JIAYU Token Float 0.1.0</string>
