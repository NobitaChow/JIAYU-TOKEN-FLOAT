...
set -eu
cd "$(dirname "$0")"
mkdir -p build/'JIAYU Token Float 2.0.2.app'/Contents/{MacOS,Resources}
APP='build/JIAYU Token Float 2.0.2.app'
...
<key>CFBundleName</key><string>JIAYU Token Float 2.0.2</string>
<key>CFBundleShortVersionString</key><string>2.0.2</string>
<key>CFBundleVersion</key><string>202</string>
