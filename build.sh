...
set -eu
cd "$(dirname "$0")"
mkdir -p build/'JIAYU Token Float 0.1.1.app'/Contents/{MacOS,Resources}
APP='build/JIAYU Token Float 0.1.1.app'
...
<key>CFBundleName</key><string>JIAYU Token Float 0.1.1</string>
