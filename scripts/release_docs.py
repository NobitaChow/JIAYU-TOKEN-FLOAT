...
manual=a.output/'JIAYU-Token-Float-0.1.1-Manual-zh-CN.pdf'
c=canvas.Canvas(str(manual),pagesize=(595,842));c.setTitle('JIAYU Token Float 0.1.1 中文使用说明书');c.setAuthor('JIAYU STUDIO')
...
def header(n,title,sub):
 ...
 txt(118,63,'JIAYU STUDIO',12,'Helvetica-Bold');txt(118,85,'TOKEN FLOAT  /  0.1.1',11,'Helvetica',muted)
...
lines(262,['打开 DMG，将应用拖入「应用程序」文件夹。','拷贝完成后，从「应用程序」打开 JIAYU Token Float 0.1.1。','最后弹出安装盘。更新已有安装时，请先退出正在运行的旧版本。'])
...
t(114,48,'JIAYU STUDIO · TOKEN FLOAT',20,'#ffffff','Helvetica-Bold');t(114,72,'家宇工作室 · 用量悬浮窗 0.1.1',12,'#ddede5')
...
t(48,537,'macOS 13+  /  Apple Silicon',10,'#6f7771','Helvetica');t(750,537,'0.1.1 · GUIDE',10,'#6f7771','Helvetica',True)
c.save();print(manual)
